...
class SeedDemoStructureJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            // Add owner as manager (routes through OrganizationMembershipService for
            // default-team invariant). OrganizationObserver::created already
            // provisioned the default team.
            app(\App\Services\OrganizationMembershipService::class)
                ->add($org, $owner, UserRole::MANAGER);
            ...
            for ($t = 0; $t < $teamsCount; $t++) {
                ...
                for ($e = 0; $e < $employeesPerTeam; $e++) {
                    ...
                    // Add to org as employee (routes through membership service for
                    // default-team invariant).
                    app(\App\Services\OrganizationMembershipService::class)
                        ->add($org, $demoUser, UserRole::EMPLOYEE);

                    // Add to explicit demo team (real team, separate from default).
