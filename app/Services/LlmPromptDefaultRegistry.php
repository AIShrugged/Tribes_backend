...
class LlmPromptDefaultRegistry
{
    ...
    {
        return [
            ['slug' => 'agent.system', 'name' => 'Agent system prompt', 'view' => 'llm-prompts.agent.system'],
            ['slug' => 'agent.section.context', 'name' => 'Agent context section', 'view' => 'llm-prompts.agent.section-context'],
            ['slug' => 'agent.section.db_schema', 'name' => 'Agent database schema section', 'view' => 'llm-prompts.agent.section-db-schema'],
            ['slug' => 'agent.section.formatting', 'name' => 'Agent formatting section', 'view' => 'llm-prompts.agent.section-formatting'],
            ['slug' => 'agent.section.id_rules', 'name' => 'Agent ID rules section', 'view' => 'llm-prompts.agent.section-id-rules'],
            ['slug' => 'agent.section.org_links', 'name' => 'Agent organization links section', 'view' => 'llm-prompts.agent.section-org-links'],
            ['slug' => 'agent.section.proactive_mode', 'name' => 'Agent proactive mode section', 'view' => 'llm-prompts.agent.section-proactive-mode'],
            ['slug' => 'agent.section.role', 'name' => 'Agent role section', 'view' => 'llm-prompts.agent.section-role'],
            ['slug' => 'agent.section.team_roster', 'name' => 'Agent team roster section', 'view' => 'llm-prompts.agent.section-team-roster'],
            ['slug' => 'agent.section.think_first', 'name' => 'Agent think first section', 'view' => 'llm-prompts.agent.section-think-first'],
            ['slug' => 'agent.section.tool_guidance', 'name' => 'Agent tool guidance section', 'view' => 'llm-prompts.agent.section-tool-guidance'],
            ['slug' => 'agenda.general.user', 'name' => 'General agenda prompt', 'view' => 'llm-prompts.agenda.general-user'],
            ['slug' => 'agenda.meeting_series_state.user', 'name' => 'Meeting series state prompt', 'view' => 'llm-prompts.agenda.meeting-series-state-user'],
            ['slug' => 'agenda.personal.user', 'name' => 'Personal agenda prompt', 'view' => 'llm-prompts.agenda.personal-user'],
            ['slug' => 'agenda.upcoming.user', 'name' => 'Upcoming agenda prompt', 'view' => 'llm-prompts.agenda.upcoming-user'],
            ['slug' => 'chat.wanda.system', 'name' => 'Wanda report chat system prompt', 'view' => 'llm-prompts.chat.wanda-system'],
