...
class MoveWorkspaceFileTool extends AbstractAgentTool
{
    ...
    {
        return 'Move or rename a file or directory within a writable workspace.';
    }
    ...
    public function execute(?array $parameters): mixed
    {
        ...
        return [
            'success' => $this->workspaceService->move($workspace, $fromPath, $toPath),
