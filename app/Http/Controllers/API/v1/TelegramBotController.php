...
class TelegramBotController extends Controller
{
    ...
    {
        //TODO: сделать работу бота в группе
        //TODO: межличностные отношения
        //TODO: инсайты (в принципе и так готовы)
        //TODO: попросить claude проинспектировать проект и выписать где логика недоделана/сломана
        //TODO: Сделать регистрацию пользователей
        //TODO: Возможно ли сделать сжатие текста и, если текст большой, то передавать в LLM фунцию, которая обратит текст обратно + сам сжатый текст???
        //TODO: сделать heartbeat, некую проактивность(от юзера давно не было сообщений и т.д.)
        try {
